...
#endif
{
    ...
    {
        flag &f = flags[i];
        settexture(m_hold && (!flagblip || !f.owner || lastmillis%1000 < 500) ? (flagblip ? "data/fps/hud/blip_neutral_flag.png" : "data/fps/hud/blip_neutral.png") :
                    ((m_hold ? ctfteamflag(f.owner->team) : f.team)==ctfteamflag(player1->team) ?
                        (flagblip ? "data/fps/hud/blip_blue_flag.png" : "data/fps/hud/blip_blue.png") :
                        (flagblip ? "data/fps/hud/blip_red_flag.png" : "data/fps/hud/blip_red.png")), 3);
    ...
    void drawhud(fpsent *d, int w, int h)
    {
        ...
        if(m_hold)
        {
            settexture("data/fps/hud/blip_neutral.png", 3);
