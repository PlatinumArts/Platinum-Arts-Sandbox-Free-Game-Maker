...
namespace game
{
    ...
    VARFP(playermodel, 0, 0, 5, { if(player1->clientnum < 0) player1->playermodel = playermodel; });
    ...
    static const playermodelinfo playermodels[] =
    {
        ...
        { "captaincannon/blue", "captaincannon/blue", "captaincannon/red", "captaincannon/hudguns", NULL, NULL, { NULL, NULL, NULL }, "captaincannon_blue", "captaincannon_blue", "captaincannon_red", true },
        { "captaincannon/red", "captaincannon/blue", "captaincannon/red", "captaincannon/hudguns", NULL, NULL, { NULL, NULL, NULL }, "captaincannon_red", "captaincannon_blue", "captaincannon_red", true },
